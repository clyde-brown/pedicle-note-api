...
- **physical_examination**: id, tenant_id, encounter_id, examination_type, status, findings
- **imaging_order**: id, tenant_id, encounter_id, modality, body_part, urgency
- **imaging_result**: id, tenant_id, imaging_order_id, findings, impression
